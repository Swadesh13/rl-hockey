...
for ppo
```bash
python -m ppo.ppo --config/ppo_hockey.yaml --train
python -m ppo.ppo --config/ppo_hockey.yaml --eval
```

for td3
```bash
cd rl-hockey 
python -m td3.td3 --config/td3_hockey.yaml --train
python -m td3.td3 --config/td3_hockey.yaml --eval
```
