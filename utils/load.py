...
def LoadTD7Agents(evalEnv: HockeyEnv_SB3 = None) -> Dict[str, TD7HockyAgent]:
    ...
    return {
        ...
        "td7_all_offensive":  TD7HockyAgent(config=config,evalEnv=evalEnv, loadModel=True, modelsDir="models", modelName="td7_all_offensive"), 
        "td7_crash":  TD7HockyAgent(config=config,evalEnv=evalEnv, loadModel=True, modelsDir="models", modelName="td7_crash"), 
        "td7_best": TD7HockyAgent(config=config,evalEnv=evalEnv, loadModel=True, modelsDir="models", modelName="td7_best"), 
    }
