...
from utils.memory import ExperienceMemory, PrioritizedMemory, PrioritizedExperienceMemory
from utils.noise import PinkNoiseDist, BrownNoiseDist
...
class SAC_PEM(SAC):
    """
    Updated training function only in case PrioritizedExperienceMemory is used
    """
...
def get_SAC_agent(env, config):
    ...
    elif config.model.prioritized_experience_memory:
        agent = SAC_PEM
        kwargs["replay_buffer_class"] = PrioritizedExperienceMemory
    else:
        agent = SAC
