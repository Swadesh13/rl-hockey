...
from .initilizer import CreatePendulumV1Env,CreatePendulumV1EnvVector
...
if __name__ == "__main__":
    ...
    evalEnv = CreatePendulumV1Env()
    trainEnv = CreatePendulumV1EnvVector(envNum=config.train_env.n_envs)
