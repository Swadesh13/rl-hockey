...
class PPO_Player(Agent):
    """A PPO hockey agent."""

    def __init__(self) -> None:
        super().__init__()

        self.hockey_agent: PPO_HockeyAgent = load_ppo_agent(
            "models/ppo/league_noload/ppo_pp_800.yaml"
        )
...
"""
python -m client.run_client --server-url comprl.cs.uni-tuebingen.de \
    --server-port 65335 \
    --token <token found on profile> \
    --args --agent=ppo
"""
